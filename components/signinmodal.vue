    ...
    <div
      ...
      <div class="relative w-full max-w-md px-4 h-96 sm:h-auto ">
        ...
        <div class="bg-white rounded-lg shadow relative dark:bg-gray-700 ">
          ...
          <div class="space-y-6 px-4 lg:px-8 pb-4 sm:pb-6 xl:pb-8">
            ...
            <div class="flex items-start">
              <div class="items-center h-5 hidden lg:inline-block">
                <button @click="resetPassword = true"
                  class="items-center h-5 text-sm text-blue-700 hover:underline dark:text-blue-500 hidden lg:inline-block">
                  Forgot Password?
                </button>
              </div>
            </div>
            ...
            <div class="text-center lg:hidden">
              <button @click="resetPassword = true"
                class="text-sm text-blue-700 hover:underline dark:text-blue-500">Forgot Password?</button>
            </div>
            <button
          ...
          <ResetPasswordModal v-if="resetPassword" @closeResetPasswordModal="resetPassword = false" />
