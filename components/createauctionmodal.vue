<template>
  ...
  >
    <div
      class="bg-white shadow-lg rounded-3xl overflow-hidden w-11/12 max-w-lg mx-auto"
    >
      ...
      <section class="p-4">
        <form @submit.prevent="createAuction">
          ...
          <div class="flex gap-4 mb-5">
            ...
            <div class="flex-1 flex flex-col">
              <label for="location" class="text-sm font-medium mb-2"
                >Location</label
              >
              <input
                v-model="auctionData.location"
                id="location"
                type="text"
                class="form-input"
          ...
          <div class="flex gap-4 mb-5">
            <div class="flex-1 flex flex-col">
              <label for="startingBid" class="text-sm font-medium mb-2"
                >Starting Bid</label
              >
              <input
                v-model.number="auctionData.startingBid"
                id="startingBid"
                type="number"
                step="1"
                min="0"
            ...
            <div class="flex-1 flex flex-col">
              <label for="biddingType" class="text-sm font-medium mb-2"
                >Bidding Type</label
              >
              <select
                v-model="auctionData.biddingType"
                id="biddingType"
                class="form-select"
                required
              >
          ...
          <div class="flex gap-4 mb-5">
            <div class="flex-1 flex flex-col">
              <label for="categoryId" class="text-sm font-medium mb-2"
                >Category</label
              >
              <select
              ...
              <div class="mt-2">
                <span
                  v-for="categoryId in auctionData.categories"
                  :key="categoryId"
            ...
            <div class="flex-1 flex flex-col">
              <label for="rarity" class="text-xs font-medium mb-2"
                >(This is where cash bond depends)</label
              >
              <select
                v-model="auctionData.rarity"
                id="rarity"
                class="form-select"
              >
