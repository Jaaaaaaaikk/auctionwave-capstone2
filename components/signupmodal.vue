          ...
          <form @submit.prevent="submitForm">
            ...
            <div class="flex flex-wrap -mx-2 mb-5">
              ...
              <div class="w-full sm:w-1/2 px-2">
                <input type="text" v-model="selectedCity" class="text-gray-500 bg-transparent border-2 rounded-md w-full" placeholder="City Location" readonly
                required />
                <button type="button" @click="toggleMap"
                  class="bg-teal-500 border border-teal-500 rounded-full hover:bg-teal-600 focus:ring-4 focus:outline-none focus:ring-teal-500 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-600 text-gray-900 px-4 ml-3 shadow-sm-light shadow-black font-semibold">
                  Select City on Map
                </button>
...
const setCity = (city) => {
    ...
    showMap.value = false; // Close the map after city selection
  };
