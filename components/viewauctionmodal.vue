<template>
  <div class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      ...
      <div class="flex flex-col border-gray-400 pb-1">
        ...
        <div class="flex items-center mb-3">
          ...
          <img v-else src="/images/default-profile-image.png" class="w-6 h-6 rounded-full mr-2" alt="No Image Available"
            loading="lazy" />
          <button @click="viewProfile = true" class="text-gray-600 text-sm hover:underline hover:cursor-pointer">{{
    ...
    <viewProfileModal v-if="viewProfile" @closeViewProfileModal="viewProfile = false"
      :auctioneerId="auction.auctioneer_id" />
  </div>
...
import viewProfileModal from "~/components/view-profile-modal.vue";
