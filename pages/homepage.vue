  ...
  <div class="flex flex-col min-h-screen bg-custom-blue2">
      ...
      <div class="flex-grow">
        <nav class="fixed top-0 left-0 w-full bg-white shadow-md z-50 h-16">
          <div class="flex justify-between items-center px-10 h-full">
            <img src="/public/images2/auctionwave-logo-final.png" class="h-10 object-contain" alt="Logo" />
      ...
      <section class="bg-white dark:bg-gray-900 mt-16">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
            <h1
              class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-custom-bluegreen dark:text-white italic">
              Online Auctions Made Easy</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Experience
              a seamless and convenient way to participate in online auctions, from anywhere and at any time.</p>
            <a href="#"
              class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg hover:bg-green-500 bg-custom-bluegreen hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
              Get started
            ...
            <div class="flex flex-col gap-16">
              <div class="flex flex-col gap-2 text-center">
                ...
                <p class="text-base font-medium leading-7 text-custom-bluegreen2">
                  AuctionWave lets users register as Auctioneers or Bidders, clearly outlining their roles from the
                  start.
                </p>
              </div>
            </div>
    ...
    <client-only>
      <div class="w-full bg-white">
          ...
          <div class="flex justify-center">
            <div class="w-3/5 mt-4">
              <div class="bg-white rounded-l-lg p-6">
                ...
                <p class="mx-14 text-gray-500 font-light text-lg">Browse a diverse selection of furniture, from modern
                  to
                  antique pieces.</p>
        ...
        <div
          class="mx-auto justify-center items-center w-8/12 my-24 transform transition-all hover:-translate-y-2 duration-300 hover:scale-105">
          <div class="flex justify-center">
            <div class="text-center w-3/5">
              <div class="mt-2 rounded-md overflow-hidden">
                <img src="/public/images2/realestate.jpg" alt="Real Estate Image" class="w-full h-full object-cover">
              </div>
            </div>
            <div class="w-3/5 mt-4">
              <div class="bg-white rounded-r-lg p-6">
        ...
        <div class="flex items-start max-w-6xl mx-auto">
          ...
          <div class="w-2/3 pl-16">
            <div class="flex flex-col items-start">
              <h2 class="mt-5 text-custom-bluegreen text-4xl font-bold tracking-tight md:text-5xl">FAQ's</h2>
            ...
            <div class="mt-8 grid max-w-xl divide-y divide-neutral-200">
              <div class="py-5">
                <details class="group">
                  ...
                  <p class="group-open:animate-fadeIn mt-3 text-neutral-600">AuctionWave is free to use for both
                    auctioneers and bidders. There may be additional fees for certain services, such as usage fees or
                    cash
              ...
              <div class="py-5">
                <details class="group">
                  ...
                  <p class="group-open:animate-fadeIn mt-3 text-neutral-600">Refunds for any fees incurred, such as
                    usage
              ...
              <div class="py-5">
                <details class="group">
                  ...
                  <p class="group-open:animate-fadeIn mt-3 text-neutral-600">Currently, AuctionWave is free to use, and
                    we
              ...
              <div class="py-5">
                <details class="group">
                  ...
                  <p class="group-open:animate-fadeIn mt-3 text-neutral-600">AuctionWave implements secure
                    authentication
