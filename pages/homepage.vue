    ...
    <section class="bg-white dark:bg-gray-900 mt-16">
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
          ...
          <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Experience
        ...
        <div class="flex justify-center">
          <div class="w-3/5 mt-4">
            <div class="bg-white rounded-l-lg p-6">
              ...
              <p class="mx-14 text-gray-500 font-light text-lg">Browse a diverse selection of furniture, from modern to
                antique pieces.</p>
