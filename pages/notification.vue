    ...
    <NuxtLayout :name="navbarLayout">
        ...
        <div class="bg-gray-100 mx-4 rounded-lg">
            ...
            <ul>
                ...
                <li v-else class="flex flex-col border-y hover:bg-gray-200 px-8"
                    ...
                    <div
                        class="relative w-full item-center flex justify-between py-2 my-1 cursor-pointer ml-2 space-x-0.5">
                        <div class="flex justify-between" @click="viewAuction(notification)">
                        ...
                        <div class="w-32 flex items-center justify-end">
                            <div v-if="hoverStates[notification.notification_id]" class="flex items-center space-x-2">
                                <button title="Mark As Read" @click="markAsRead(notification.notification_id)"
                                ...
                                <button title="Mark As Unread" @click="markAsUnread(notification.notification_id)">
                                ...
                                <!-- Delete Button -->
                                <button title="Delete" @click="deleteNotification(notification.notification_id)">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="text-gray-500 hover:text-custom-bluegreen h-5 w-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
