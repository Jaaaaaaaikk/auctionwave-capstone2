      ...
      <div class="flex flex-wrap mx-auto w-5/6 ">
        ...
        <div class="filter-container w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0" @click="filterPendingCashbonds">
          <div
            ...
            <div class="mx-5">
              <h4 class="text-2xl font-semibold text-gray-700">{{ totalPaymentCompleted }}</h4>
              <div class="text-gray-500">Payment Completed</div>
            </div>
          </div>
        </div>
...
const totalPaymentCompleted = ref(0);
...
const filterPendingCashbonds = () => {
  ...
  selectedPaymentStatus.value = "Payment Completed";
  selectedTransactionStatus.value = "";
  isFiltered.value = true;
  isSearching.value = true;
  currentPage.value = 1;
...
const fetchAuctions = async () => {
  try {
    ...
    totalPaymentCompleted.value = data.totalCashbondPending;
