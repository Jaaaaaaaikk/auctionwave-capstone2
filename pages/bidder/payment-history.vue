                ...
                <div class="mx-auto max-w-5xl">
                    <div class="gap-4 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div class="mt-6 gap-4 space-y-4 sm:mt-0 sm:flex sm:items-center sm:justify-end sm:space-y-0">
                            <div>
                                <select id="order-type" v-model="selectedPaymentStatus" @change="resetPaymentStatus"
                            ...
                            <div v-else v-for="auction in filteredAuctions" :key="auction.payment_id"
                                ...
                                <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                                    ...
                                    <dd :class="getStatusClass(auction.payment_status)"
                                        ...
                                        <svg v-if="auction.payment_status === 'Payment Completed'" class="me-1 h-3 w-3"
                                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            fill="none" viewBox="0 0 24 24">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="2" d="M5 11.917 9.724 16.5 19 7.5" />
                                        </svg>
                                        <svg v-if="auction.payment_status === 'Payment Refunded'" class="me-1 h-3 w-3"
                                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            fill="none" viewBox="0 0 24 24">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
