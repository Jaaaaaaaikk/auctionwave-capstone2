      ...
      <div v-if="auction" class="max-w-screen-xl px-4 mx-auto 2xl:px-0 pt-10">
        <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
            ...
            <p class="font-medium text-gray-900 dark:text-gray-400">{{ auction.item_details }}</p>
            <p class="font-medium mt-3">Description:</p>
          ...
          <div class="mt-6 sm:mt-8 lg:mt-0 px-4">
            ...
            <div v-if="auction.bidding_type === 'Lowest-type'" class="my-4">
              ...
              <span v-else-if="remainingTime <= 0" class="text-red-300"> (Auction Ended)</span>
            </div>
