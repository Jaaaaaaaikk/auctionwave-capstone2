                            ...
                            <div v-else v-for="auction in filteredAuctions" :key="auction.listing_id"
                                ...
                                <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                                    ...
                                    <dd :class="getStatusClass(auction.transaction_status)"
                                        ...
                                        <svg v-if="auction.transaction_status === 'Transaction Disputed'"
                                ...
                                <div
                                    ...
                                    <button @click="handleAction(auction)"
                                        :disabled="isButtonDisabled(auction.transaction_status)"
                                        ...
                                        {{ getButtonText(auction.transaction_status) }}
                                    </button>
                                </div>
                            </div>
                        </div>
...
const isButtonDisabled = (status) => {
    const disabledStatuses = ['Transaction Failed', 'Transaction Completed'];
