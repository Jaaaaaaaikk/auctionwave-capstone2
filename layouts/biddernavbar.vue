<template>
  <div class="font-mono p-6 bg-white dark:bg-gray-900 min-h-screen">
    <!-- Header Section -->
    <div
      class="fixed top-0 left-0 right-0 px-4 py-4 flex items-center justify-between bg-white shadow-xl mb-6"
    >
      <!-- Logo and Company Name -->
      <NuxtLink
        to="/bidder/bidderdashboard"
            ...
            >
              <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                <li>
                  ...
                  >
                    <svg
                      class="w-4 h-4 mr-2 text-gray-500 dark:text-gray-200"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
