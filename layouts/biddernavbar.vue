      ...
      <div class="flex items-center rtl:space-x-reverse w-full">
        ...
        <div class="flex space-x-8 rtl:space-x-reverse flex-grow">
          <NuxtLink to="/bidder/bidding-history"
            class="text-gray-900 dark:text-white text-xl hover:text-blue-700 dark:hover:text-blue-500">Bidding History
          </NuxtLink>
          <NuxtLink to="/inbox"
            class="text-gray-900 dark:text-white text-xl hover:text-blue-700 dark:hover:text-blue-500">Transaction
            History</NuxtLink>
          ...
          <NuxtLink :to="{ path: '/contactus', query: { userType: userType } }"
            class="text-gray-900 dark:text-white text-xl hover:text-blue-700 dark:hover:text-blue-500">Contact Us
          </NuxtLink>
          ...
          <div class="relative">
            <button @click="toggleNotificationDropdown"
              ...
              <span v-if="unreadCount > 0"
                class="absolute top-0 right-0 w-2.5 h-2.5 bg-red-600 rounded-full"></span>
            </button>
